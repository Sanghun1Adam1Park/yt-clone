...
async def process_video(message) -> dict:
    try:
        ...
        _, stderr = await loop.run_in_executor(None, process.communicate) # communicate is blocking
        ...
        return {
            "status_code":400, "detail":"Invalid message payload received."
        }
    except RuntimeError as e:
        logging.error(f"Conversion error: {e}")
        return {
            "status_code":500, "detail":"Convertion failed."
        }
    except Exception as e:
